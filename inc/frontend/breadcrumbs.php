...
if ( ! function_exists( 'codexin_breadcrumbs' ) ) {
	...
	function codexin_breadcrumbs() {
		...
		if ( is_page() ) {
			$bcrumb_position = ( ! empty( $bcrumb_single ) ) && ( 'global' !== $bcrumb_single ) ? $bcrumb_single : '';
		}

		if ( 'flex-start' === $bcrumb_position ) {
			$bcrumb_alignment_class = ' justify-content-md-start';
		} elseif ( 'flex-end' === $bcrumb_position ) {
		...
		echo sprintf( '%s', $breadcrumb_output_link );
	}
} // End if().
