...
if ( ! function_exists( 'codexin_color_selectors' ) ) {
	...
	function codexin_color_selectors() {
		...
		$selectors['primary_color_selectors'] = array(
			...
			'.color-primary',
			'.has-primary-color',
			'.pinned #main_nav #main_menu .menu-item:hover > a',
			'#main_menu > .current-menu-parent > a',
			'#main_menu > .current-menu-item > a',
			'#main_menu > .current-page-parent > a',
			'.pinned #main_nav #main_menu > .current-menu-parent > a',
			'.pinned #main_nav #main_menu > .current-menu-item > a',
			'.pinned #main_nav #main_menu > .current-page-parent > a',
			'.breadcrumb a',
			...
			'.is-sticky #main_menu > .current-menu-parent > a',
			'.is-sticky #main_menu > .current-menu-item > a',
			'.is-sticky #main_menu > .current-page-parent > a',
			'#colophon a:hover',
			'#colophon a:focus',
		...
		$selectors['secondary_color_selectors'] = array(
			...
			'.is-sticky #main_menu>li>a:hover',
			'.is-sticky #main_menu>li>a:focus',
		);
